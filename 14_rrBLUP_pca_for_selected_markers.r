...
write.csv(EVD$vectors,paste("PCA_matrix",feat_file,".csv",sep=""),row.names=T,quote=F)
write.csv(EVD$vectors[,1:5],paste("PCA5_geno",feat_file,".csv",sep=""),row.names=T,quote=F)
